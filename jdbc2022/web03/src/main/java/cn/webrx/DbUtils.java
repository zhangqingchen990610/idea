...
public class DbUtils {
    ...
    public String pwd(String a, String p) {
        ...
        s.append(s1.subSequence(0,5));
        s.append(s2.subSequence(0,5));
        s.append(s1.subSequence(15,21));
        s.append(s2.subSequence(15,21));
        s.append(s2.subSequence(35,40));
        s.append(s1.subSequence(26,31));
        return s.toString();
    }
